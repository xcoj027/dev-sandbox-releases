...
[![Release](https://img.shields.io/github/v/releases/xcoj027/dev-sandbox-release?include_prereleases&style=for-the-badge&logo=github&color=blue)](https://github.com/xcoj027/dev-sandbox-releases/releases)
[![Platform](https://img.shields.io/badge/Platform-macOS%20%7C%20Windows%20%7C%20Linux-brightgreen?style=for-the-badge)](https://github.com/xcoj027/dev-sandbox-releases/releases)
[![License](https://img.shields.io/badge/License-MIT-orange?style=for-the-badge)](https://github.com/xcoj027/dev-sandbox-releases/blob/main/LICENSE)

[**Download Latest Release**](https://github.com/xcoj027/dev-sandbox-releases/releases/latest) • [**Features**](#features) • [**Installation**](#installation--quick-start) • [**Documentation**](#how-it-works)
...
Official standalone builds with an embedded Java runtime are available directly on the [**Releases Page**](https://github.com/xcoj027/dev-sandbox-releases/releases/latest):

| Operating System | Package Format | Details | Download Link |
| :--- | :--- | :--- | :--- |
| **macOS** (Intel / Apple Silicon) | **`.dmg`** | Native installer with drag-and-drop to Applications | [Download `.dmg`](https://github.com/xcoj027/dev-sandbox-releases/releases/tag/latest) |
| **macOS** (Portable) | **`.zip`** | Portable `DevSandbox.app` bundle | [Download `.zip`](https://github.com/xcoj027/dev-sandbox-releases/releases/tag/latest) |
| **Windows** (64-bit) | **`.zip`** | Portable folder with `DevSandbox.exe` (no installation required) | [Download `.zip`](https://github.com/xcoj027/dev-sandbox-releases/releases/tag/latest) |
| **Linux** (Debian / Ubuntu) | **`.deb`** | Standard desktop package installer with launcher shortcut | [Download `.deb`](https://github.com/xcoj027/dev-sandbox-releases/releases/tag/latest) |
| **Linux** (Any Distro) | **`.tar.gz`** | Portable standalone binary bundle with embedded JRE | [Download `.tar.gz`](https://github.com/xcoj027/dev-sandbox-releases/releases/tag/latest) |
| **Universal (Cross-Platform)** | **`.jar`** | Pure executable JAR (requires Java 21+) | [Download `.jar`](https://github.com/xcoj027/dev-sandbox-releases/releases/tag/latest) |
...
For issue reports, feature suggestions, or questions, please open an [Issue](https://github.com/xcoj027/dev-sandbox-releases/issues).
